...
def copy_raw_files_to_input_folder(n=5000):
    """Copy raw files to input folder with numbering"""
    initialize_directory("files/input")
    copy_and_number_raw_files_to_input_folder("files/raw", "files/input", n)


def run_job(input_dir, output_dir):
    """Run the mapreduce job"""
    # Remove output directory if it exists to avoid the error
